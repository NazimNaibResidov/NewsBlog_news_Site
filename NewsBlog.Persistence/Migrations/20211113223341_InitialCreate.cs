        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tiksinti = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(nullable: true),
                    BigPath = table.Column<string>(nullable: true),
                    SmallPath = table.Column<string>(nullable: true),
                    MidlePath = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Content = table.Column<string>(nullable: true),
                    KateoriId = table.Column<int>(nullable: true),
                    ImageId = table.Column<int>(nullable: true),
                    NewsTypeId = table.Column<int>(nullable: true),
                    NewsTime = table.Column<DateTime>(nullable: true),
